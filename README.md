...
## About
Kocom Wallpad with RS485 for 센트럴타워푸르지오

## Installation

1. 홈어시스턴트의 Hass.io > ADD-ON STORE에서 Add new repository by URL에 https://github.com/vapury/kocom.py 를 입력한 다음 ADD 버튼을 누릅니다.
...
7. share/kocom/ 폴더에 있는 kocom.conf 파일을 본인의 환경에 맞게 수정합니다(EW11, HA Server, MTQQ ID, PW).
8. "START" 버튼으로 애드온을 실행합니다.
9. HA를 재시작하시면 반드시 애드온을 중지 후 재시작 해야 작동합니다.
10. 엘리베이터는 알수없음 상태라서 안되는게 아니라, 토글로 사용하지말고, 전원켜고, 전원 켜질 때 호출됩니다.
...
(2023-07-20 수정) 에어컨 연동 추가

(2023-07-08 수정) room5 까지 추가
